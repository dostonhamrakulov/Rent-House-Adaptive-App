    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.id_about_us:
                Toast.makeText(AdaptiveDisplay.this, "I am Junior Android Developer!!!", Toast.LENGTH_LONG).show();
                return true;
            case R.id.id_contact_us:
                Toast.makeText(AdaptiveDisplay.this, "If you want to cantact me, please write email to doston2509@gmail.com!!!",
